...
(test/deftest sample-1-intersections
  (test/is (= [[0 0] [6 5] [3 3]] (sut/find-intersections "R8,U5,L5,D3" "U7,R6,D4,L4"))))

(test/deftest sample-1-closest
  (test/is (= 6 (sut/closest-intersection "R8,U5,L5,D3" "U7,R6,D4,L4"))))

(test/deftest sample-2-closest
  (test/is (= 159 (sut/closest-intersection "R75,D30,R83,U83,L12,D49,R71,U7,L72"
                                            "U62,R66,U55,R34,D71,R55,D58,R83"))))

(test/deftest sample-3-closest
  (test/is (= 135 (sut/closest-intersection "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51"
                                            "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"))))

(def wire-1
  "The first wire in the puzzle input."
...
(def wire-2
  "The second wire in the puzzle input."
...
(test/deftest part-1
  (test/is (= 651 (sut/closest-intersection wire-1 wire-2))))

(test/deftest sample-1-intersections-with-steps
  (test/is (= [[0 0 0 0] [6 5 15 15] [3 3 20 20]] (sut/find-intersections-with-steps "R8,U5,L5,D3" "U7,R6,D4,L4"))))

(test/deftest sample-1-closest-with-steps
  (test/is (= 30 (sut/closest-intersection-with-steps "R8,U5,L5,D3" "U7,R6,D4,L4"))))

(test/deftest sample-2-closest-with-steps
  (test/is (= 610 (sut/closest-intersection-with-steps "R75,D30,R83,U83,L12,D49,R71,U7,L72"
                                                       "U62,R66,U55,R34,D71,R55,D58,R83"))))

(test/deftest sample-3-closest-with-steps
  (test/is (= 410 (sut/closest-intersection-with-steps "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51"
                                                       "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"))))


(test/deftest part-2
  (test/is (= 7534 (sut/closest-intersection-with-steps wire-1 wire-2))))
